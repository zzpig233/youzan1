    ...
    <div class="section section-first">
      <div class="block form js-form">
        ...
        <div class="block-item" style="border-top:0;">
          <label>收货人</label>
          <input type="text" placeholder="请输入姓名" name="user_name" v-model:value="name" maxlength="20">
        </div>
        <div class="block-item">
          <label>联系电话</label>
          <input type="tel" placeholder="联系电话" name="tel" v-model:value="tel" maxlength="11">
        </div>
        <div class="block-item">
          <label>选择地区</label>
        ...
        <div class="block-item">
          <label>详细地址</label>
          <input type="text" placeholder="街道门牌信息" name="address_detail" v-model:value="address" maxlength="100">
        </div>
      </div>
    </div>
